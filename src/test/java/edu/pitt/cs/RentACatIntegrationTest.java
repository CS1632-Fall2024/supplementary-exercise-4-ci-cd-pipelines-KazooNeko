...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() {
		Class<?> rentCat = r.getClass();
		try {
			Method m = rentCat.getDeclaredMethod("getCat", int.class);
			m.setAccessible(true);
			Object returnValue = m.invoke(r, 2);

			assertNull("Cat returned is not Null", returnValue);
	...
	public void testGetCatNumCats3() {
		...
		try {
			...
			assertNotNull("Cat returned is null", ret);
			assertEquals("CatID is not equal to 2", 2, ret.getId());
	...
	public void testListCatsNumCats0() {
		...
		assertEquals("listCats() should return \"\"", "", ret);
		return;
	}
	...
	public void testListCatsNumCats3() {
		...
		assertEquals("Print output does not match expected", "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", ret);
		return;
	}
	...
	public void testRenameFailureNumCats0() {
		...
		assertFalse("renameCat(2) should return false", ret);
		assertNotEquals("c2 name should not be Garfield", "Garfield", c2.getName());
		assertEquals("Did not print correct error message", "Invalid cat ID." + newline, out.toString());
		return;
	}
	...
	public void testRenameNumCat3() {
		...
		assertTrue("renameCat() should return true", ret);
		assertEquals("c2 name should be Garfield", "Garfield", c2.getName());
		return;
	}
	...
	public void testRentCatNumCats3() {
		...
		assertTrue("rentCat(2) should return true", ret);
		assertTrue("c2 should be rented", c2.getRented());
		assertEquals("Print output does not match expected.", "Old Deuteronomy has been rented." + newline, out.toString());
		return;
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse("rentCat(2) should return false", ret);
		assertTrue("c2 should be rented", c2.getRented());
		assertEquals("Print output does not match expected.", "Sorry, Old Deuteronomy is not here!" + newline, out.toString());
		return;
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("returnCat(2) should return true", ret);
		assertFalse("c2 should be returned", c2.getRented());
		assertEquals("Print output does not match expected.", "Welcome back, Old Deuteronomy!" + newline, out.toString());
		return;
	}
	...
	public void testReturnFailureCatNumCats3() {
		...
		assertFalse("returnCat(2) should return false", ret);
		assertFalse("c2 should not be rented", c2.getRented());
		assertEquals("Print output does not match expected", "Old Deuteronomy is already here!" + newline, out.toString());
		return;
	}
